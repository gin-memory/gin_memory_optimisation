...
//    }
    ...
    public List<ImportDeclaration> getImportDeclarations() {
        ...
        for (ImportDeclaration impDec : compilationUnit.getChildNodesByType(ImportDeclaration.class)) {
            result.add(impDec);
        }
        return result;
    }

    public void addImport(ImportDeclaration iMd) {
        compilationUnit.addImport(iMd);
    }
