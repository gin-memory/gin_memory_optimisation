...
import gin.edit.modifynode.CollectionReplacement;
    ...
    public static List<Class<? extends Edit>> getEditClassesOfType(EditType editType) {
            switch (editType) {
                    ...
                    case MODIFY_STATEMENT:
                                return Arrays.asList(BinaryOperatorReplacement.class, UnaryOperatorReplacement.class, CollectionReplacement.class);
                        default:
