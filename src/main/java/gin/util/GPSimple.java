...
//    }
    ...
    // Adds a random edit of the given type with skewed probabilities among allowed types
    protected Patch mutate(Patch oldPatch) {
        ...
        if (randomNum < 0.3){
            patch.addRandomEditOfClass(super.mutationRng, MatchedReplaceStatement.class);
        } else if (randomNum > 0.3) {
            patch.addRandomEditOfClass(super.mutationRng, SwapStatement.class);
        }
//
//
//        Patch patch = oldPatch.clone();
